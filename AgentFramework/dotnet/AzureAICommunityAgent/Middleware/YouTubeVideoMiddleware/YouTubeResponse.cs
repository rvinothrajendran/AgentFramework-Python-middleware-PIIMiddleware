...
/// <summary>
/// Represents a single YouTube video result returned by the search middleware.
/// Contains the video's watch URL, title, and description extracted from the API response.
/// </summary>
public class YouTubeResponse
{
    ...
    public override string ToString() =>
        $"Title: {Title}\tDescription: {Description}\tVideo Url: {YouTubeVideoUrl}";
}